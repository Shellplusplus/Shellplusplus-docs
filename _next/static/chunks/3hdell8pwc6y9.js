(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,449897,e=>{"use strict";var o=e.i(67479);let a=`#version 300 es
...
`,Y={name:"Default",params:{...m,speed:.5,frame:0,colorBack:"#000000",colors:["#ffffff"],noiseScale:3,noiseIterations:8,radius:.25,thickness:.65,innerShape:.7,scale:.8}},G={name:"Solar",params:{...m,speed:1,frame:0,colorBack:"#000000",colors:["#ffffff","#ffca0a","#fc6203","#fc620366"],noiseScale:2,noiseIterations:3,radius:.4,thickness:.8,innerShape:4,scale:2,offsetY:1}},W=[Y,{name:"Line",params:{...m,frame:0,colorBack:"#000000",colors:["#4540a4","#1fe8ff"],noiseScale:1.1,noiseIterations:2,radius:.38,thickness:.01,innerShape:.88,speed:4}},G,{name:"Cloud",params:{...m,frame:0,colorBack:"#81ADEC",colors:["#ffffff"],noiseScale:3,noiseIterations:10,radius:.5,thickness:.65,innerShape:.85,speed:.5,scale:2.5}}],P=(0,o.memo)(function({speed:e=Y.params.speed,frame:o=Y.params.frame,colorBack:a=Y.params.colorBack,colors:t=Y.params.colors,noiseScale:r=Y.params.noiseScale,thickness:i=Y.params.thickness,radius:s=Y.params.radius,innerShape:l=Y.params.innerShape,noiseIterations:f=Y.params.noiseIterations,fit:u=Y.params.fit,scale:m=Y.params.scale,rotation:p=Y.params.rotation,originX:h=Y.params.originX,originY:v=Y.params.originY,offsetX:_=Y.params.offsetX,offsetY:x=Y.params.offsetY,worldWidth:y=Y.params.worldWidth,worldHeight:w=Y.params.worldHeight,...b}){let A={u_colorBack:g(a),u_colors:t.map(g),u_colorsCount:t.length,u_noiseScale:r,u_thickness:i,u_radius:s,u_innerShape:l,u_noiseIterations:f,u_noiseTexture:I(),u_fit:d[u],u_scale:m,u_rotation:p,u_offsetX:_,u_offsetY:x,u_originX:h,u_originY:v,u_worldWidth:y,u_worldHeight:w};return(0,n.jsx)(c,{...b,speed:e,frame:o,fragmentShader:D,uniforms:A})},u),T=`#version 300 es
precision mediump float;
...
`,j={name:"Default",params:{...p,speed:1.5,frame:0,colorBack:"#000000",colors:["#ffc96b","#ff6200","#ff2f00","#421100","#1a0000"],size:1,sizeRange:0,spreading:1,stepsPerColor:4}},K={name:"Shine",params:{...p,speed:.1,frame:0,colors:["#ffffff","#006aff","#fff675"],colorBack:"#000000",stepsPerColor:4,size:.3,sizeRange:.2,spreading:1,scale:.4}},q=[j,{name:"Bubbles",params:{...p,speed:.4,frame:0,colors:["#D0D2D5"],colorBack:"#989CA4",stepsPerColor:2,size:.9,sizeRange:.7,spreading:1,scale:1.64}},K,{name:"Hallucinatory",params:{...p,speed:5,frame:0,colors:["#000000"],colorBack:"#ffe500",stepsPerColor:2,size:.65,sizeRange:0,spreading:.3,scale:.5}}],J=(0,o.memo)(function({speed:e=j.params.speed,frame:o=j.params.frame,colorBack:a=j.params.colorBack,colors:t=j.params.colors,size:r=j.params.size,sizeRange:i=j.params.sizeRange,spreading:s=j.params.spreading,stepsPerColor:l=j.params.stepsPerColor,fit:f=j.params.fit,scale:u=j.params.scale,rotation:m=j.params.rotation,originX:p=j.params.originX,originY:h=j.params.originY,offsetX:v=j.params.offsetX,offsetY:_=j.params.offsetY,worldWidth:x=j.params.worldWidth,worldHeight:y=j.params.worldHeight,...w}){let b={u_colorBack:g(a),u_colors:t.map(g),u_colorsCount:t.length,u_size:r,u_sizeRange:i,u_spreading:s,u_stepsPerColor:l,u_noiseTexture:I(),u_fit:d[f],u_scale:u,u_rotation:m,u_offsetX:v,u_offsetY:_,u_originX:p,u_originY:h,u_worldWidth:x,u_worldHeight:y};return(0,n.jsx)(c,{...w,speed:e,frame:o,fragmentShader:L,uniforms:b})},u),Z=`#version 300 es
precision mediump float;
...
`,ew={name:"Default",params:{...p,speed:.5,frame:0,colorBack:"#632ad5",colorFront:"#fccff7",proportion:.35,softness:.1,octaveCount:1,persistence:1,lacunarity:1.5}},eb=[ew,{name:"Nintendo Water",params:{...p,scale:5,speed:.4,frame:0,colorBack:"#2d69d4",colorFront:"#d1eefc",proportion:.42,softness:0,octaveCount:2,persistence:.55,lacunarity:1.8}},{name:"Moss",params:{...p,scale:1/.15,speed:.02,frame:0,colorBack:"#05ff4a",colorFront:"#262626",proportion:.65,softness:.35,octaveCount:6,persistence:1,lacunarity:2.55}},{name:"Worms",params:{...p,scale:.9,speed:0,frame:0,colorBack:"#ffffff00",colorFront:"#595959",proportion:.5,softness:0,octaveCount:1,persistence:1,lacunarity:1.5}}],eA=(0,o.memo)(function({speed:e=ew.params.speed,frame:o=ew.params.frame,colorFront:a=ew.params.colorFront,colorBack:t=ew.params.colorBack,proportion:r=ew.params.proportion,softness:i=ew.params.softness,octaveCount:s=ew.params.octaveCount,persistence:l=ew.params.persistence,lacunarity:f,fit:u=ew.params.fit,worldWidth:m=ew.params.worldWidth,worldHeight:p=ew.params.worldHeight,scale:h=ew.params.scale,rotation:v=ew.params.rotation,originX:_=ew.params.originX,originY:x=ew.params.originY,offsetX:y=ew.params.offsetX,offsetY:w=ew.params.offsetY,...b}){let A={u_colorBack:g(t),u_colorFront:g(a),u_proportion:r,u_softness:i??ew.params.softness,u_octaveCount:s??ew.params.octaveCount,u_persistence:l??ew.params.persistence,u_lacunarity:f??ew.params.lacunarity,u_fit:d[u],u_scale:h,u_rotation:v,u_offsetX:y,u_offsetY:w,u_originX:_,u_originY:x,u_worldWidth:m,u_worldHeight:p};return(0,n.jsx)(c,{...b,speed:e,frame:o,fragmentShader:ey,uniforms:A})},u),eC={maxColorCount:5},eB=`#version 300 es
precision mediump float;
...
`,eS={name:"Default",params:{...p,speed:.5,frame:0,colors:["#ff8247","#ffe53d"],stepsPerColor:3,colorGlow:"#ffffff",colorGap:"#2e0000",distortion:.4,gap:.04,glow:0,scale:.5}},ek={name:"Cells",params:{...p,scale:.5,speed:.5,frame:0,colors:["#ffffff"],stepsPerColor:1,colorGlow:"#ffffff",colorGap:"#000000",distortion:.5,gap:.03,glow:.8}},eU={name:"Bubbles",params:{...p,scale:.75,speed:.5,frame:0,colors:["#83c9fb"],stepsPerColor:1,colorGlow:"#ffffff",colorGap:"#ffffff",distortion:.4,gap:0,glow:1}},eV=[eS,{name:"Lights",params:{...p,scale:3.3,speed:.5,frame:0,colors:["#fffffffc","#bbff00","#00ffff"],colorGlow:"#ff00d0",colorGap:"#ff00d0",stepsPerColor:2,distortion:.38,gap:0,glow:1}},ek,eU],eR=(0,o.memo)(function({speed:e=eS.params.speed,frame:o=eS.params.frame,colors:a=eS.params.colors,stepsPerColor:t=eS.params.stepsPerColor,colorGlow:r=eS.params.colorGlow,colorGap:i=eS.params.colorGap,distortion:s=eS.params.distortion,gap:l=eS.params.gap,glow:f=eS.params.glow,fit:u=eS.params.fit,scale:m=eS.params.scale,rotation:p=eS.params.rotation,originX:h=eS.params.originX,originY:v=eS.params.originY,offsetX:_=eS.params.offsetX,offsetY:x=eS.params.offsetY,worldWidth:y=eS.params.worldWidth,worldHeight:w=eS.params.worldHeight,...b}){let A={u_colors:a.map(g),u_colorsCount:a.length,u_stepsPerColor:t,u_colorGlow:g(r),u_colorGap:g(i),u_distortion:s,u_gap:l,u_glow:f,u_noiseTexture:I(),u_fit:d[u],u_scale:m,u_rotation:p,u_offsetX:_,u_offsetY:x,u_originX:h,u_originY:v,u_worldWidth:y,u_worldHeight:w};return(0,n.jsx)(c,{...b,speed:e,frame:o,fragmentShader:eB,uniforms:A})},u),eF={maxColorCount:10},ez=`#version 300 es
precision mediump float;
...
`,eG={name:"Default",params:{...m,offsetX:0,offsetY:-.55,colorBack:"#000000",colorBloom:"#0000ff",colors:["#a600ff6e","#6200fff0","#ffffff","#33fff5"],density:.3,spotty:.3,midIntensity:.4,midSize:.2,intensity:.8,bloom:.4,speed:.75,frame:0}},eW=[eG,{name:"Warp",params:{...m,colorBack:"#000000",colorBloom:"#222288",colors:["#ff47d4","#ff8c00","#ffffff"],density:.45,spotty:.15,midIntensity:.4,midSize:.33,intensity:.79,bloom:.4,speed:2,frame:0}},{name:"Linear",params:{...m,offsetX:.2,offsetY:-.8,colorBack:"#000000",colorBloom:"#eeeeee",colors:["#ffffff1f","#ffffff3d","#ffffff29"],density:.41,spotty:.25,midSize:.1,midIntensity:.75,intensity:.79,bloom:1,speed:.5,frame:0}},{name:"Ether",params:{...m,offsetX:-.6,colorBack:"#090f1d",colorBloom:"#ffffff",colors:["#148effa6","#c4dffebe","#232a47"],density:.03,spotty:.77,midSize:.1,midIntensity:.6,intensity:.6,bloom:.6,speed:1,frame:0}}],eP=(0,o.memo)(function({speed:e=eG.params.speed,frame:o=eG.params.frame,colorBloom:a=eG.params.colorBloom,colorBack:t=eG.params.colorBack,colors:r=eG.params.colors,density:i=eG.params.density,spotty:s=eG.params.spotty,midIntensity:l=eG.params.midIntensity,midSize:f=eG.params.midSize,intensity:u=eG.params.intensity,bloom:m=eG.params.bloom,fit:p=eG.params.fit,scale:h=eG.params.scale,rotation:v=eG.params.rotation,originX:_=eG.params.originX,originY:x=eG.params.originY,offsetX:y=eG.params.offsetX,offsetY:w=eG.params.offsetY,worldWidth:b=eG.params.worldWidth,worldHeight:A=eG.params.worldHeight,...C}){let B={u_colorBloom:g(a),u_colorBack:g(t),u_colors:r.map(g),u_colorsCount:r.length,u_density:i,u_spotty:s,u_midIntensity:l,u_midSize:f,u_intensity:u,u_bloom:m,u_noiseTexture:I(),u_fit:d[p],u_scale:h,u_rotation:v,u_offsetX:y,u_offsetY:w,u_originX:_,u_originY:x,u_worldWidth:b,u_worldHeight:A};return(0,n.jsx)(c,{...C,speed:e,frame:o,fragmentShader:eY,uniforms:B})},u),eT=`#version 300 es
precision mediump float;
...
`,eK={name:"Default",params:{...m,speed:.32,frame:0,colorBack:"#330000",colors:["#ffd1d1","#ff8a8a","#660000"],bandCount:4,twist:.1,center:.2,proportion:.5,softness:0,noiseFrequency:.4,noise:.2}},eq={name:"Opening",params:{...m,offsetX:-.4,offsetY:1,speed:.5,frame:0,colorBack:"#ff8b61",colors:["#fefff0","#ffd8bd","#ff8b61"],bandCount:2,twist:.3,center:.2,proportion:.5,softness:0,noiseFrequency:0,noise:0,scale:1}},eJ=[eK,{name:"007",params:{...m,speed:1,frame:0,colorBack:"#E9E7DA",colors:["#000000"],bandCount:5,twist:.3,center:0,proportion:0,softness:0,noiseFrequency:.5,noise:0}},eq,{name:"Candy",params:{...m,speed:1,frame:0,colorBack:"#ffcd66",colors:["#6bbceb","#d7b3ff","#ff9fff"],bandCount:2,twist:.15,center:.2,proportion:.5,softness:1,noiseFrequency:.5,noise:0}}],eZ=(0,o.memo)(function({speed:e=eK.params.speed,frame:o=eK.params.frame,colorBack:a=eK.params.colorBack,colors:t=eK.params.colors,bandCount:r=eK.params.bandCount,twist:i=eK.params.twist,center:s=eK.params.center,proportion:l=eK.params.proportion,softness:f=eK.params.softness,noiseFrequency:u=eK.params.noiseFrequency,noise:m=eK.params.noise,fit:p=eK.params.fit,rotation:h=eK.params.rotation,scale:v=eK.params.scale,originX:_=eK.params.originX,originY:x=eK.params.originY,offsetX:y=eK.params.offsetX,offsetY:w=eK.params.offsetY,worldWidth:b=eK.params.worldWidth,worldHeight:A=eK.params.worldHeight,...C}){let B={u_colorBack:g(a),u_colors:t.map(g),u_colorsCount:t.length,u_bandCount:r,u_twist:i,u_center:s,u_proportion:l,u_softness:f,u_noiseFrequency:u,u_noise:m,u_fit:d[p],u_scale:v,u_rotation:h,u_offsetX:y,u_offsetY:w,u_originX:_,u_originY:x,u_worldWidth:b,u_worldHeight:A};return(0,n.jsx)(c,{...C,speed:e,frame:o,fragmentShader:ej,uniforms:B})},u),e$=`#version 300 es
precision mediump float;
...
`,oR={name:"Default",params:{...m,fit:"cover",scale:.6,speed:0,frame:0,colorFront:"#9fadbc",colorBack:"#ffffff",contrast:.3,roughness:.4,fiber:.3,fiberSize:.2,crumples:.3,crumpleSize:.35,folds:.65,foldCount:5,fade:0,drops:.2,seed:5.8}},oF={name:"Abstract",params:{...m,fit:"cover",speed:0,frame:0,scale:.6,colorFront:"#00eeff",colorBack:"#ff0a81",contrast:.85,roughness:0,fiber:.1,fiberSize:.2,crumples:0,crumpleSize:.3,folds:1,foldCount:3,fade:0,drops:.2,seed:2.2}},oz=[oR,{name:"Cardboard",params:{...m,fit:"cover",speed:0,frame:0,scale:.6,colorFront:"#c7b89e",colorBack:"#999180",contrast:.4,roughness:0,fiber:.35,fiberSize:.14,crumples:.7,crumpleSize:.1,folds:0,foldCount:1,fade:0,drops:.1,seed:1.6}},oF,{name:"Details",params:{...m,speed:0,frame:0,fit:"cover",scale:3,colorFront:"#00000000",colorBack:"#00000000",contrast:0,roughness:1,fiber:.27,fiberSize:.22,crumples:1,crumpleSize:.5,folds:1,foldCount:15,fade:0,drops:0,seed:6}}],oM=(0,o.memo)(function({speed:e=oR.params.speed,frame:o=oR.params.frame,colorFront:a=oR.params.colorFront,colorBack:t=oR.params.colorBack,image:r="",contrast:i=oR.params.contrast,roughness:s=oR.params.roughness,fiber:l=oR.params.fiber,crumples:f=oR.params.crumples,folds:u=oR.params.folds,drops:m=oR.params.drops,seed:p=oR.params.seed,fiberScale:h,fiberSize:v=void 0===h?oR.params.fiberSize:.2/h,crumplesScale:_,crumpleSize:x=void 0===_?oR.params.crumpleSize:.2/_,blur:y,fade:w=void 0===y?oR.params.fade:y,foldsNumber:b,foldCount:A=void 0===b?oR.params.foldCount:b,fit:C=oR.params.fit,scale:B=oR.params.scale,rotation:S=oR.params.rotation,originX:k=oR.params.originX,originY:U=oR.params.originY,offsetX:V=oR.params.offsetX,offsetY:R=oR.params.offsetY,worldWidth:F=oR.params.worldWidth,worldHeight:z=oR.params.worldHeight,...M}){let O="u">typeof window&&{u_noiseTexture:I()},E={u_image:r,u_colorFront:g(a),u_colorBack:g(t),u_contrast:i,u_roughness:s,u_fiber:l,u_fiberSize:v,u_crumples:f,u_crumpleSize:x,u_foldCount:A,u_folds:u,u_fade:w,u_drops:m,u_seed:p,...O,u_fit:d[C],u_scale:B,u_rotation:S,u_offsetX:V,u_offsetY:R,u_originX:k,u_originY:U,u_worldWidth:F,u_worldHeight:z};return(0,n.jsx)(c,{...M,speed:e,frame:o,fragmentShader:oV,mipmaps:["u_image"],uniforms:E})},u),oI=`#version 300 es
precision mediump float;
...
`,oT={name:"Default",params:{...m,scale:.8,speed:1,frame:0,colorBack:"#909090",colorHighlight:"#ffffff",highlights:.07,layering:.5,edges:.8,waves:.3,caustic:.1,size:1}},oQ={name:"Abstract",params:{...m,fit:"cover",scale:3,speed:1,frame:0,colorBack:"#909090",colorHighlight:"#ffffff",highlights:0,layering:0,edges:1,waves:1,caustic:.4,size:.15}},oN={name:"Streaming",params:{...m,fit:"contain",scale:.4,speed:2,frame:0,colorBack:"#909090",colorHighlight:"#ffffff",highlights:0,layering:0,edges:0,waves:.5,caustic:0,size:.5}},oX=[oT,{name:"Slow-mo",params:{...m,fit:"cover",scale:1,speed:.1,frame:0,colorBack:"#909090",colorHighlight:"#ffffff",highlights:.4,layering:0,edges:0,waves:0,caustic:.2,size:.7}},oQ,oN],oH=(0,o.memo)(function({speed:e=oT.params.speed,frame:o=oT.params.frame,colorBack:a=oT.params.colorBack,colorHighlight:t=oT.params.colorHighlight,image:r="",highlights:i=oT.params.highlights,layering:s=oT.params.layering,waves:l=oT.params.waves,edges:f=oT.params.edges,caustic:u=oT.params.caustic,effectScale:m,size:p=void 0===m?oT.params.size:10/9/m-1/9,fit:h=oT.params.fit,scale:v=oT.params.scale,rotation:_=oT.params.rotation,originX:x=oT.params.originX,originY:y=oT.params.originY,offsetX:w=oT.params.offsetX,offsetY:b=oT.params.offsetY,worldWidth:A=oT.params.worldWidth,worldHeight:C=oT.params.worldHeight,...B}){let S={u_image:r,u_colorBack:g(a),u_colorHighlight:g(t),u_highlights:i,u_layering:s,u_waves:l,u_edges:f,u_caustic:u,u_size:p,u_fit:d[h],u_rotation:_,u_scale:v,u_offsetX:w,u_offsetY:b,u_originX:x,u_originY:y,u_worldWidth:A,u_worldHeight:C};return(0,n.jsx)(c,{...B,speed:e,frame:o,fragmentShader:oP,mipmaps:["u_image"],uniforms:S})},u),oL=`#version 300 es
precision mediump float;
...
`,oj={name:"Default",params:{...m,fit:"cover",speed:0,frame:0,colorFront:"#94ffaf",colorBack:"#000c38",colorHighlight:"#eaff94",type:"8x8",size:2,colorSteps:2,originalColors:!1,inverted:!1}},oK={name:"Retro",params:{...m,fit:"cover",speed:0,frame:0,colorFront:"#eeeeee",colorBack:"#5452ff",colorHighlight:"#eeeeee",type:"2x2",size:3,colorSteps:1,originalColors:!0,inverted:!1}},oq=[oj,{name:"Noise",params:{...m,fit:"cover",speed:0,frame:0,colorFront:"#a2997c",colorBack:"#000000",colorHighlight:"#ededed",type:"random",size:1,colorSteps:1,originalColors:!1,inverted:!1}},oK,{name:"Natural",params:{...m,fit:"cover",speed:0,frame:0,colorFront:"#ffffff",colorBack:"#000000",colorHighlight:"#ffffff",type:"8x8",size:2,colorSteps:5,originalColors:!0,inverted:!1}}],oJ=(0,o.memo)(function({speed:e=oj.params.speed,frame:o=oj.params.frame,colorFront:a=oj.params.colorFront,colorBack:t=oj.params.colorBack,colorHighlight:r=oj.params.colorHighlight,image:i="",type:s=oj.params.type,colorSteps:l=oj.params.colorSteps,originalColors:f=oj.params.originalColors,inverted:u=oj.params.inverted,pxSize:m,size:p=void 0===m?oj.params.size:m,fit:h=oj.params.fit,scale:v=oj.params.scale,rotation:_=oj.params.rotation,originX:x=oj.params.originX,originY:y=oj.params.originY,offsetX:w=oj.params.offsetX,offsetY:b=oj.params.offsetY,worldWidth:A=oj.params.worldWidth,worldHeight:C=oj.params.worldHeight,...B}){let S={u_image:i,u_colorFront:g(a),u_colorBack:g(t),u_colorHighlight:g(r),u_type:e1[s],u_pxSize:p,u_colorSteps:l,u_originalColors:f,u_inverted:u,u_fit:d[h],u_rotation:_,u_scale:v,u_offsetX:w,u_offsetY:b,u_originX:x,u_originY:y,u_worldWidth:A,u_worldHeight:C};return(0,n.jsx)(c,{...B,speed:e,frame:o,fragmentShader:oL,uniforms:S})},u),oZ={maxColorCount:10},o$=`#version 300 es
...
`;function av(e){let o=document.createElement("canvas"),a=o.getContext("2d"),t="string"==typeof e&&e.startsWith("blob:");return new Promise((r,i)=>{if(!e||!a)return void i(Error("Invalid file or canvas context"));let s=t&&fetch(e).then(e=>e.headers.get("Content-Type")),l=new Image;l.crossOrigin="anonymous";let n=performance.now();l.onload=async()=>{let t,n=await s;t=n?"image/svg+xml"===n:"string"==typeof e?e.endsWith(".svg")||e.startsWith("data:image/svg+xml"):"image/svg+xml"===e.type;let f=l.width||l.naturalWidth,c=l.height||l.naturalHeight;if(t){let e=f/c;f>c?(f=4096,c=4096/e):(c=4096,f=4096*e),l.width=f,l.height=c}let u=512/Math.min(f,c),m=Math.round(f*u),p=Math.round(c*u);o.width=f,o.height=c;let d=Math.ceil(.025*m),g=Math.ceil(.025*p),h=m-2*d,v=p-2*g,_=document.createElement("canvas");_.width=m,_.height=p;let x=_.getContext("2d");x.drawImage(l,d,g,h,v);let y=performance.now(),w=x.getImageData(0,0,m,p).data,b=new Uint8Array(m*p),A=new Uint8Array(m*p),C=0;for(let e=0,o=0;e<w.length;e+=4,o++){let a=+(0!==w[e+3]);b[o]=a,C+=a}let B=[],S=[];for(let e=0;e<p;e++)for(let o=0;o<m;o++){let a=e*m+o;if(b[a])0!==o&&o!==m-1&&0!==e&&e!==p-1&&b[a-1]&&b[a+1]&&b[a-m]&&b[a+m]&&b[a-m-1]&&b[a-m+1]&&b[a+m-1]&&b[a+m+1]?S.push(a):(A[a]=1,B.push(a))}let k=function(e,o,a,t,r){let i=o.length,s=new Int32Array(4*i);for(let a=0;a<i;a++){let i=o[a],l=i%t,n=Math.floor(i/t);s[4*a+0]=l<t-1&&e[i+1]?i+1:-1,s[4*a+1]=l>0&&e[i-1]?i-1:-1,s[4*a+2]=n>0&&e[i-t]?i-t:-1,s[4*a+3]=n<r-1&&e[i+t]?i+t:-1}return{interiorPixels:o,boundaryPixels:a,pixelCount:i,neighborIndices:s}}(b,new Uint32Array(S),new Uint32Array(B),m,p),U=performance.now(),V=function(e,o,a){let t=new Float32Array(o*a),{interiorPixels:r,neighborIndices:i,pixelCount:s}=e,l=performance.now(),n=[],f=[];for(let e=0;e<s;e++){let a=r[e];(a%o+Math.floor(a/o))%2==0?n.push(e):f.push(e)}for(let e=0;e<32;e++){for(let e of n){let o=r[e],a=i[4*e+0],s=i[4*e+1],l=i[4*e+2],n=i[4*e+3],f=0;a>=0&&(f+=t[a]),s>=0&&(f+=t[s]),l>=0&&(f+=t[l]),n>=0&&(f+=t[n]);let c=(.01+f)/4;t[o]=1.9*c+-.8999999999999999*t[o]}for(let e of f){let o=r[e],a=i[4*e+0],s=i[4*e+1],l=i[4*e+2],n=i[4*e+3],f=0;a>=0&&(f+=t[a]),s>=0&&(f+=t[s]),l>=0&&(f+=t[l]),n>=0&&(f+=t[n]);let c=(.01+f)/4;t[o]=1.9*c+-.8999999999999999*t[o]}}let c=new Float32Array(o*a);for(let e=0;e<3;e++){c.set(t);for(let e=0;e<s;e++){let o=r[e],a=i[4*e+0],s=i[4*e+1],l=i[4*e+2],n=i[4*e+3],f=0,u=0;a>=0&&(f+=c[a],u++),s>=0&&(f+=c[s],u++),l>=0&&(f+=c[l],u++),n>=0&&(f+=c[n],u++),t[o]=u>0?(c[o]+f/u)*.5:c[o]}}0;return t}(k,m,p);let R=0;for(let e=0;e<S.length;e++){let o=S[e];V[o]>R&&(R=V[o])}let F=document.createElement("canvas");F.width=m,F.height=p;let z=F.getContext("2d"),M=z.createImageData(m,p);for(let e=0;e<p;e++)for(let o=0;o<m;o++){let a=e*m+o,t=4*a;if(b[a]){let e=255*(1-V[a]/R);M.data[t]=e,M.data[t+1]=e,M.data[t+2]=e,M.data[t+3]=255}else M.data[t]=255,M.data[t+1]=255,M.data[t+2]=255,M.data[t+3]=0}z.putImageData(M,0,0),a.imageSmoothingEnabled=!0,a.imageSmoothingQuality="high",a.drawImage(F,0,0,m,p,0,0,f,c);let I=a.getImageData(0,0,f,c),O=Math.ceil(.025*f),E=Math.ceil(.025*c),D=document.createElement("canvas");D.width=f,D.height=c;let Y=D.getContext("2d");Y.drawImage(l,O,E,f-2*O,c-2*E);let G=Y.getImageData(0,0,f,c);for(let e=0;e<I.data.length;e+=4){let o=G.data[e+3],a=I.data[e+3];0===o?(I.data[e]=255,I.data[e+1]=0):(I.data[e]=0===a?0:I.data[e],I.data[e+1]=o),I.data[e+2]=255,I.data[e+3]=255}a.putImageData(I,0,0),o.toBlob(e=>{if(!e)return void i(Error("Failed to create PNG blob"));0;r({imageData:I,pngBlob:e})},"image/png")},l.onerror=()=>i(Error("Failed to load image")),l.src="string"==typeof e?e:URL.createObjectURL(e)})}let a_={none:0,circle:1,daisy:2,diamond:3,metaballs:4},ax={name:"Default",params:{...m,scale:.6,speed:1,frame:0,colorBack:"#f0efea",colorInner:"#fafaf5",colors:["#333333","#e7e6df"],outerGlow:.55,innerGlow:1,innerDistortion:.8,outerDistortion:.6,offset:0,angle:0,size:.8,shape:"diamond"}},ay={name:"Fluorescent",params:{...m,scale:.6,speed:1,frame:0,colorBack:"#000000",colorInner:"#000000",colors:["#2fb64c","#cdff61","#ffffff"],outerGlow:0,innerGlow:1,innerDistortion:1,outerDistortion:.8,offset:0,angle:0,size:.8,shape:"diamond"}},aw=[ax,{name:"Fire",params:{...m,scale:.6,speed:1,frame:0,colorBack:"#000000",colorInner:"#000000",colors:["#fe5b16","#f7ff61","#ffffff"],outerGlow:1,innerGlow:.65,innerDistortion:.6,outerDistortion:.8,offset:0,angle:0,size:.8,shape:"diamond"}},ay,{name:"Infrared",params:{...m,scale:.6,speed:.5,frame:0,colorBack:"#cd28dc",colorInner:"#00000000",colors:["#ff9900","#fff67a","#dcff52","#00ffbb","#0077ff"],outerGlow:1,innerGlow:1,innerDistortion:1,outerDistortion:1,offset:.2,angle:0,size:1,shape:"diamond"}}],ab=(0,o.memo)(function({colorBack:e=ax.params.colorBack,colors:a=ax.params.colors,speed:t=ax.params.speed,frame:r=ax.params.frame,image:i="",innerDistortion:s=ax.params.innerDistortion,outerDistortion:l=ax.params.outerDistortion,outerGlow:f=ax.params.outerGlow,innerGlow:u=ax.params.innerGlow,colorInner:m=ax.params.colorInner,offset:p=ax.params.offset,angle:h=ax.params.angle,size:v=ax.params.size,shape:_=ax.params.shape,suspendWhenProcessingImage:x=!1,fit:y=ax.params.fit,scale:w=ax.params.scale,rotation:b=ax.params.rotation,originX:A=ax.params.originX,originY:C=ax.params.originY,offsetX:B=ax.params.offsetX,offsetY:S=ax.params.offsetY,worldWidth:k=ax.params.worldWidth,worldHeight:U=ax.params.worldHeight,...V}){let R,F="string"==typeof i?i:i.src,[z,M]=(0,o.useState)(o5);R=x&&"u">typeof window&&F?o4(()=>av(F).then(e=>URL.createObjectURL(e.pngBlob)),[F,"gemSmoke"]):z,(0,o.useLayoutEffect)(()=>{if(x)return;if(!F)return void M(o5);let e=!0;return av(F).then(o=>{e&&M(URL.createObjectURL(o.pngBlob))}),()=>{e=!1}},[F,x]);let I={u_colors:a.map(g),u_colorsCount:a.length,u_colorBack:g(e),u_image:R,u_innerDistortion:s,u_outerDistortion:l,u_outerGlow:f,u_innerGlow:u,u_colorInner:g(m),u_offset:p,u_angle:h,u_size:v,u_isImage:!!i,u_shape:a_[_],u_fit:d[y],u_scale:w,u_rotation:b,u_offsetX:B,u_offsetY:S,u_originX:A,u_originY:C,u_worldWidth:k,u_worldHeight:U};return(0,n.jsx)(c,{...V,speed:t,frame:r,fragmentShader:ah,mipmaps:["u_image"],uniforms:I})},u);e.s([],729321),e.i(729321),e.s(["ColorPanels",0,og,"Dithering",0,e6,"DotGrid",0,ea,"DotOrbit",0,J,"FlutedGlass",0,oW,"GemSmoke",0,ab,"GodRays",0,eP,"GrainGradient",0,or,"HalftoneCmyk",0,ag,"HalftoneDots",0,ac,"Heatmap",0,o6,"ImageDithering",0,oJ,"LiquidMetal",0,ar,"MeshGradient",0,M,"Metaballs",0,eg,"NeuroNoise",0,X,"PaperTexture",0,oM,"PerlinNoise",0,eA,"PulsingBorder",0,oc,"ShaderMount",0,c,"SimplexNoise",0,en,"SmokeRing",0,P,"Spiral",0,eH,"StaticMeshGradient",0,ow,"StaticRadialGradient",0,oU,"Swirl",0,eZ,"Voronoi",0,eR,"Warp",0,eE,"Water",0,oH,"Waves",0,ex,"colorPanelsMeta",0,ou,"colorPanelsPresets",0,od,"ditheringPresets",0,e9,"dotGridPresets",0,eo,"dotOrbitMeta",0,H,"dotOrbitPresets",0,q,"flutedGlassPresets",0,oG,"gemSmokePresets",0,aw,"getShaderColorFromString",0,g,"godRaysMeta",0,eD,"godRaysPresets",0,eW,"grainGradientMeta",0,e7,"grainGradientPresets",0,ot,"halftoneCmykPresets",0,ad,"halftoneDotsPresets",0,af,"heatmapMeta",0,oZ,"heatmapPresets",0,o9,"imageDitheringPresets",0,oq,"isPaperShaderElement",0,function(e){return"paperShaderMount"in e},"liquidMetalPresets",0,at,"meshGradientMeta",0,k,"meshGradientPresets",0,z,"metaballsMeta",0,ef,"metaballsPresets",0,ed,"neuroNoisePresets",0,N,"paperTexturePresets",0,oz,"perlinNoisePresets",0,eb,"pulsingBorderMeta",0,oi,"pulsingBorderPresets",0,of,"simplexNoiseMeta",0,et,"simplexNoisePresets",0,el,"smokeRingMeta",0,E,"smokeRingPresets",0,W,"spiralPresets",0,eX,"staticMeshGradientMeta",0,oh,"staticMeshGradientPresets",0,oy,"staticRadialGradientMeta",0,ob,"staticRadialGradientPresets",0,ok,"swirlMeta",0,eL,"swirlPresets",0,eJ,"voronoiMeta",0,eC,"voronoiPresets",0,eV,"warpMeta",0,eF,"warpPresets",0,eO,"waterPresets",0,oX,"wavesPresets",0,e_],449897)},259686,e=>{e.n(e.i(449897))}]);