...
2. 退出应用，返回表盘，点击Claude小人<InvertImage>![Claude 表盘入口](./images/open-claude-watch-face.png)</InvertImage>
3. 点击start<InvertImage>![启动 Shell++ 服务](./images/start-shellpp-service.jpg)</InvertImage>
4. 此时服务环境就已配置完毕
